    ...
    <nav className="sticky top-0 z-50 bg-slate-900/85 backdrop-blur-md border-b border-slate-800 text-slate-100 px-6 py-4">
      <div className="max-w-6xl mx-auto flex justify-between items-center">
        ...
        <div className="flex items-center gap-4">
          ...
          {/* LinkedIn Icon */}
          <a href="https://www.linkedin.com/in/rahmat-opoola-ba6801263/" target="_blank" rel="noopener noreferrer" className="text-slate-300 hover:text-emerald-400 transition" aria-label="LinkedIn">
            <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
          ...
          {/* Mail Icon */}
          <a href="mailto:rahmatopoola9@gmail.com" className="text-slate-300 hover:text-emerald-400 transition" aria-label="Email">
            <Mail size={20} />
          </a>
        </div>
      </div>
