    ...
    <section id="contact" className="py-20 bg-slate-950 text-slate-100 px-6">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="flex flex-wrap justify-center gap-6 mb-12">
          ...
          <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 bg-slate-900 border border-slate-800 hover:border-emerald-500/50 px-6 py-3 rounded-xl transition text-slate-300 hover:text-emerald-400">
